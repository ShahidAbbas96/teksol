...
export default function Contact() {
  return (
    <>
      <SEO
        title="Contact Us | Book an ERP Consultation | TechSols"
        description="Get in touch with TechSols to discuss your Odoo implementation, customization, integration, or support needs."
        path="/contact"
      />
